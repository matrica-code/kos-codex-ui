...
import { TeamListStory, TeamListStoryWithData } from "./team-list.stories";
...
<Snippet name={["model-index@user-container-model.ts", "model-index-get@user-container-model.ts"]} />
